...
#------------------------------------------------------------------------------#
# 5. Night Light Intensity Map (for a specific year, e.g., 2022)
#------------------------------------------------------------------------------#

# Filter data for 2022
NL_data_2022 <- NL_data %>% filter(year == 2022)

# Create the plot
nightlight_map <- ggplot() +
  geom_sf(data = shapefile_Dhaka_boundari, fill = NA, color = "black", size = 0.5) +
  geom_sf(data = NL_data_2022, aes(fill = VIIRS_NTL), color = NA) +
  scale_fill_viridis_c(option = "inferno", name = "Night Light Intensity",
  ...
  labs(
    title = "Night Light Intensity in Dhaka (2022)",
    caption = "Data Source: VIIRS Nighttime Lights | Visualization: Bachir Sabo"
  ) +
  coord_sf()

# Save the plot
ggsave("reports/plots/dhaka_nightlight_intensity_2022.png", nightlight_map, width = 12, height = 10, dpi = 300)




# Create a data frame for flood events with image paths
flood_events <- data.frame(
  year = c(2015, 2017, 2019, 2020, 2022, 2024),
  category = factor(c(1, 3, 2, 2, 1, 3)),
  image = c(
    "C:/Users/bachi/Documents/GIT_PROJECTS/Assessing-Urban-Flood-Risk-in-Dhaka-Bangladesh/data/Raw/flood_category_1.png",
    "C:/Users/bachi/Documents/GIT_PROJECTS/Assessing-Urban-Flood-Risk-in-Dhaka-Bangladesh/data/Raw/flood_category_3.png",
    "C:/Users/bachi/Documents/GIT_PROJECTS/Assessing-Urban-Flood-Risk-in-Dhaka-Bangladesh/data/Raw/flood_category_2.png",
    "C:/Users/bachi/Documents/GIT_PROJECTS/Assessing-Urban-Flood-Risk-in-Dhaka-Bangladesh/data/Raw/flood_category_2.png",
    "C:/Users/bachi/Documents/GIT_PROJECTS/Assessing-Urban-Flood-Risk-in-Dhaka-Bangladesh/data/Raw/flood_category_1.png",
    "C:/Users/bachi/Documents/GIT_PROJECTS/Assessing-Urban-Flood-Risk-in-Dhaka-Bangladesh/data/Raw/flood_category_3.png"
  )
...
#------------------------------------------------------------------------------#
# 6. Create the plot with normalized data and flood event + icones for flood categories
#------------------------------------------------------------------------------#
...
river_discharge_animation <- ggplot() +
  ...
  scale_fill_gradientn(
    colors = c("#E5F2FF", "#B3D9FF", "#80C1FF", "#4DA9FF", "#1A91FF", "#0066CC", "#004C99", "#003366"),
